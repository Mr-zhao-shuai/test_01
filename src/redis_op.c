...
//int rop_get_string(redisContex *conn, char *key, char *re_val)
int rop_get_string(redisContext *conn, char *key, char *re_val)
{
    int ret = 0;
